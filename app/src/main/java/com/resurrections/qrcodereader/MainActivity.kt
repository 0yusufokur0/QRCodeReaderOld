package com.resurrections.qrcodereader
...
import com.resurrections.qrcodereader.databinding.ActivityMainBinding
import com.resurrections.qrcodereader.databinding.DetectionResultLayoutBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun setUpAlertDialog() {
        ...
        builder.setNegativeButton("save and continue") { dialog, which ->
            // save room db
        }
    ...
    private fun setUpSurface(){
        binding.barcodeSurfaceView.holder.addCallback(object : SurfaceHolder.Callback2 {
            ...
            override fun surfaceChanged(p0: SurfaceHolder, p1: Int, p2: Int, p3: Int) = println()
